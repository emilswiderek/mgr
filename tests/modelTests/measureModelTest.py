...
class TestMeasureModel(unittest.TestCase):
    def test_insert_sql(self):
        ...
        sql = obj._insertSQL()
        testSQL = "INSERT INTO mgr.measure (measure_type, breath_period, heart_period, min_breath_period, max_breath_period, breath_number, response_function) VALUES ('test', 100, 200, NULL, NULL, 101, 'NULL')"
